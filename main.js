...
global.channelLink = "https://chat.whatsapp.com/CMJEKpoXlegBAj3QeBE865?s=cl&p=a&ilr=1";
global.ytch = "Hamid Hacker";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://chat.whatsapp.com/CMJEKpoXlegBAj3QeBE865?s=cl&p=a&ilr=1'
                }, { quoted: message });
                return;
