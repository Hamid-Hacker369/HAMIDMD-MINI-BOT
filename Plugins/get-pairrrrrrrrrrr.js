const { cmd, commands } = require('../hamid');
...
cmd({
    ...
    react: "✅",
    desc: "Get pairing code for hamid-MD bot",
    category: "download",
    use: ".pair 92323***",
    filename: __filename
    ...
    try {
        ...
        const response = await axios.get(`https://hamid-mini-bot-e4ec84c138eb.herokuapp.com/code?number=${encodeURIComponent(phoneNumber)}`);
