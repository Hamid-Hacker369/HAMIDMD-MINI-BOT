...
//REMOVE ADMINS BY HAMID-MD OFFICIAL 
cmd({
...
async (conn, mek, m, {
    ...
    try {
        const ignoreJids = [
            "9232l134270199@s.whatsapp.net",  // JID to be ignored
            "923134270199@s.whatsapp.net"   // Another JID to be ignored
        ];
